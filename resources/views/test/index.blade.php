          ...
          <div class="row align-items-center h-100">
              <div class="col-md-12 text-center">
                ...
                <p data-animation-in="slideInLeft" data-duration-in="1.2">
                    <a href={{ route('services') }} class="slider btn btn-primary">Our Services</a>
                    <a href={{ route('contact') }} class="slider btn btn-primary border">Contact Now</a>
                </p>
              </div>
          </div>
        </div>
          ...
          <div class="row align-items-center h-100">
              <div class="col-md-12">
                ...
                <p data-animation-in="slideInRight">
                    <a href={{ route('services') }} class="slider btn btn-primary border">Our Services</a>
                </p>
              </div>
          </div>
        </div>
          ...
          <div class="row align-items-center h-100">
              <div class="col-md-12">
                ...
                <div data-animation-in="slideInLeft">
                    <a href={{ route('contact') }} class="slider btn btn-primary" aria-label="contact-with-us">Get Free Quote</a>
                    <a href={{ route('about') }} class="slider btn btn-primary border" aria-label="learn-more-about-us">Learn more</a>
                </div>
              </div>
          </div>
        </div>
...
<section id="news" class="news">
  <div class="container">
    ...
    <div class="row">
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="latest-post">
              <div class="latest-post-media">
                <a href={{ route('news_single') }} class="latest-post-img">
                    <img loading="lazy" class="img-fluid" src="images/news/news1.jpg" alt="img">
                </a>
              </div>
              <div class="post-body">
                <h4 class="post-title">
                    <a href={{ route('news_single') }} class="d-inline-block">We Just Completes $17.6 million Medical Clinic in Mid-Missouri</a>
                </h4>
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="latest-post">
              ...
              <div class="post-body">
                <h4 class="post-title">
                    <a href={{ route('news_single') }} class="d-inline-block">Thandler Airport Water Reclamation Facility Expansion Project Named</a>
                </h4>
                <div class="latest-post-meta">
                    <span class="post-item-date">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
          <div class="latest-post">
              ...
              <div class="post-body">
                <h4 class="post-title">
                    <a href={{ route('news_single') }} class="d-inline-block">Silicon Bench and Cornike Begin Construction Solar Facilities</a>
                </h4>
                <div class="latest-post-meta">
                    <span class="post-item-date">
    ...
    <div class="general-btn text-center mt-4">
        <a class="btn btn-primary" href={{ route('news_left_sidebar') }}>See All Posts</a>
    </div>
