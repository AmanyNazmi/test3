          ...
          <div class="post-body">
            <div class="entry-header">
              ...
              <h2 class="entry-title">
                <a href={{ route('news_single') }}>We Just Completes $17.6 million Medical Clinic in Mid-Missouri</a>
              </h2>
            </div>
            ...
            <div class="post-footer">
              <a href={{ route('news_single') }} class="btn btn-primary">Continue Reading</a>
            </div>
        ...
        <div class="post">
          ...
          <div class="post-body">
            <div class="entry-header">
              ...
              <h2 class="entry-title">
                <a href={{ route('news_single') }}>Thandler Airport Water Reclamation Facility Expansion Project Named</a>
              </h2>
            </div>
        ...
        <div class="post">
          ...
          <div class="post-body">
            <div class="entry-header">
              ...
              <h2 class="entry-title">
                <a href={{ route('news_single') }}>Silicon Bench and Cornike Begin Construction of Large-Scale Solar Facilities
                  for Trade</a>
              </h2>
            </div>
